...
char readIRSensor(int pin)
{
  ...
  return ((char) d) + 31; // add 31 to avoid control characters
}
...
{  
  ...
  return ((char) range) + 31; // adding 31 to avoid control characters
}
...
//  /*
//    Scale pulse by relevant speed Coefficient, with SPEED_BASELINE as the origin
//  */
