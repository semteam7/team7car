...
void readFromSerial() {
  ...
  if(Serial.available() > 0)
  {
    ...
    String speedFloat = command.substring(0,colonIndex); 
    String angleFloat = command.substring(colonIndex + 1, command.length());
    
    inSpeed = (speedFloat.toFloat() * 20) + 90;
    inAngle = 90 + angleFloat.toFloat();
